function stc = MyDataProcessor_BJT_Data1_IcVceIb_3D(data, name, R_Ib, unit_Ic, unit_Ib)
%%
%{
Input format:
列 1      2        3      4        5      6
...
stc.label_left.x.String = 'Collector-Emitter Voltage $V_{CE}$ (V)';
stc.label_left.y.String = "Collector Current $I_{B}$ (" + unit_Ib + ')';
stc.label_left.z.String = "Collector Current $I_{C}$ (" + unit_Ic + ')';
stc.label_right.x.String = 'Collector-Emitter Voltage $V_{CE}$ (V)';
stc.label_right.y.String = "Collector Current $I_{B}$ (" + unit_Ib + ')';
