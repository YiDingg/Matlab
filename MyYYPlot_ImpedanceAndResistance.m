function stc = MyYYPlot_ImpedanceAndResistance(X, Z_abs, Phase_deg, Rs_abs, Xs_abs)
    stc = MyYYPlot_2window(X, [Z_abs; Phase_deg], [Rs_abs; Xs_abs]);
